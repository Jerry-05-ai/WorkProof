 ...
 * In production, cross-site cookies require SameSite=None; Secure.
 * In development (http localhost), use Lax so the cookie is stored.
 */
function cookieOptions() {
  ...
  return {
    ...
    domain: isProd ? 'work-proof-qeqh.vercel.app' : undefined,
...
export function assertTenantAccess(req, companyId) {
  ...
  if (companyId === null || companyId === undefined || userCompany === null || userCompany !== Number(companyId)) {
